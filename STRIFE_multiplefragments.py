...
class STRIFE:
    ...
    def __init__(self, args):
        ...
        assert args.model_type in [0, 1, 2, 3], 'Please provide a valid setting for generating molecules: 0, 1 or 2. See the "Running STRIFE" section of the github readme for more details'
...
if __name__=='__main__':
    ...
    parser.add_argument('--model_type', '-t', type = int, default = 0,
                        help = 'Specify which setting you wish to generate the molecules with: 0 -> default STRIFE algorithm, 0.5 -> new hotspots, 1 -> simultaneously satisfy multiple pharmacophoric points (only recommended if you have manually specified the pharmacophores), 2 -> run the STRIFE algorithm without refinement. Default %(default)s')
